...
<html>
	<head>
		...
		<link rel='stylesheet'href='resources/easyui/1.4/themes/metro/easyui.css' />
		<link rel='stylesheet' 	href='resources/easyui/1.4/themes/icon.css' />
	    <link rel='stylesheet' 	href='resources/easyui/1.4/themes/color.css' />
        <link type='text/css' rel='stylesheet' href='resources/custom/0.0.1/css/site_style.css'/>
        		
		<script src="resources/easyui/1.4/jquery.min.js"></script>
		<script src="resources/easyui/1.4/jquery.easyui.min.js"></script>
		<script src='/static/easyui/1.4/locale/easyui-lang-zh_CN.js'></script>
	</head>
	<body>
